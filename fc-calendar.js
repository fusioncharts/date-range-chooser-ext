    ...
    var UNDEFINED,
        ...
        validateStyle = function (calendar, _graphic) {
            ...
            graphic.height = (graphic.height > 199 && _graphic.height || 
                (visuals.height && Number((visuals.height).match(/\d+/g)[0])) || 150);
            graphic.width = (_graphic.width > 299 && _graphic.width ||
             (visuals.width && Number((visuals.width).match(/\d+/g)[0])) || 200);

            style.position = _graphic.position || graphic.position || 'absolut';
